...
<title>Task Status Update By Assignee</title>
...
<body>
	...
	Assigner asgner = assignerDao.findById(task.getAssignerId()).get();
	%>
			...
			<div class="col-md-4 offset-md-4 admin">
				<div class="card">
					...
					<div class="card-body px-5">
						...
						<form action="updateAssigneeTaskStatus" method="post">
							<input type="hidden" name="id" value="<%=task.getId()%>">
							<input type="hidden" name="assignerStatus" value="<%=task.getAssignerStatus()%>">
							<input type="hidden" name="assignerRemark" value="<%=task.getAssignerRemark()%>">
							...
							<div class="form-group">
								<label>Assigner Name</label> <input type="text"
									class="form-control" name="name"
									value="<%=asgner.getFirstname() + " " + asgner.getLastname()%>"
									required readonly>
							</div>
							...
							<div class="form-group">
								<label for="email">Assignee Status</label> <select
									name="assigneeStatus" class="form-control">
